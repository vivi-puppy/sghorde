...
public class ApiConst {
    ...
    public static final ResourceLocation CORROSION_RESISTANCE_TRAIT_ID = SilentGear.getId("corrosion_resistance");
    ...
    public static final ModResourceLocation BONEMEAL_TRAIT_ID = SilentGear.getId("bonemeal");
