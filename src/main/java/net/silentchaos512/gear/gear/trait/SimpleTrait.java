...
public class SimpleTrait implements ITrait {
    public static final Serializer<SimpleTrait> SERIALIZER = new Serializer<>(ApiConst.SIMPLE_TRAIT_ID,
            SimpleTrait::new);
    ...
    @Override
    public void onGetAttributeModifiers(TraitActionContext context, Multimap<Attribute, AttributeModifier> modifiers,
            String slot) {
    }
    ...
    @Override
    public void onBlockMined(TraitActionContext context, BlockState state, BlockPos pos) {
    }
